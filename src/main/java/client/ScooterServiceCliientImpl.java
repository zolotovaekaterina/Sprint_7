...
public class ScooterServiceCliientImpl implements ScooterServiceClient {
    ...
    public ScooterServiceCliientImpl(RequestSpecification requestSpecification, ResponseSpecification responseSpecification) {
